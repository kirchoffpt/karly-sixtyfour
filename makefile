...
uciengine.exe : uciengine.obj  search.obj ttable.obj
	cl uciengine.obj chess_pos.obj chess_moves_lut.obj node_move_list.obj chess_funcs.obj search.obj ttable.obj
...
search.obj :  $(SRC_DIR)/search.cpp  $(SRC_DIR)/search.h  $(SRC_DIR)/constants.h  $(SRC_DIR)/chess_pos.h  $(SRC_DIR)/ttable.h
...
chess_funcs.obj :  $(SRC_DIR)/chess_funcs.cpp  $(SRC_DIR)/chess_funcs.h  $(SRC_DIR)/constants.h $(SRC_DIR)/chess_moves_lut.h
